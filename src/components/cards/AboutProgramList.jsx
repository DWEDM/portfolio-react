    ...
    <>
        ...
        <li>
            ...
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Adobe_Photoshop_CC_icon.svg/1200px-Adobe_Photoshop_CC_icon.svg.png" alt="icon" />
                Adobe Photoshop – Graphic editing and photo manipulation
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Adobe_Illustrator_CC_icon.svg/800px-Adobe_Illustrator_CC_icon.svg.png" alt="icon" />
                Adobe Illustrator – Vector-based illustration and design
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://images.squarespace-cdn.com/content/v1/5fb0aea913eba3050d739796/bb5a5288-51fb-4b0c-ab03-b4479c6f3a47/sb_icon.png" alt="icon" />
                Autodesk Sketchbook – Digital drawing and painting tool
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://play-lh.googleusercontent.com/3aWGqSf3T_p3F6wc8FFvcZcnjWlxpZdNaqFVEvPwQ1gTOPkVoZwq6cYvfK9eCkwCXbRY" alt="icon" />
                Canva – Online graphic design platform
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://avatars.githubusercontent.com/u/5155369?s=200&v=4" alt="icon" />
                Figma – Collaborative UI/UX design tool
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Calligrakrita-base.svg/960px-Calligrakrita-base.svg.png" alt="icon" />
                Krita – Free and open-source digital painting tool
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://www.gimp.org/images/frontpage/wilber-big.png" alt="icon" />
        ...
        <li>
            ...
            <ul className="pl-4 space-y-6">
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://upload.wikimedia.org/wikipedia/commons/9/92/Bootstrap_Studio_Logo.png" alt="icon" />
            ...
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://images.seeklogo.com/logo-png/30/2/github-logo-png_seeklogo-304612.png" alt="icon" />
        ...
        <li>
            ...
            <ul className="pl-4 space-y-6">
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://www.markusantonwolf.com/topics/alpine-js/alpinejs-logo.svg" alt="icon" />
                Alpine.js – Lightweight JavaScript framework
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://upload.wikimedia.org/wikipedia/commons/1/18/C_Programming_Language.svg" alt="icon" />
                C – Low-level programming language
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://cdn-icons-png.flaticon.com/256/6132/6132222.png" alt="icon" />
                C++ – Object-oriented programming language
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://upload.wikimedia.org/wikipedia/commons/b/bd/Logo_C_sharp.svg" alt="icon" />
                C# – Microsoft’s language for .NET development
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://cdn-icons-png.flaticon.com/512/5968/5968242.png" alt="icon" />
            ...
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://cdn-icons-png.flaticon.com/512/5968/5968267.png" alt="icon" />
                HTML – Markup language for web content
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://upload.wikimedia.org/wikipedia/commons/6/6a/JavaScript-logo.png" alt="icon" />
                JavaScript – Core scripting language of the web
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTR-LhSen1K-3xSIN8e4c4FgarQ-fheIgbzI8RZn4VfxVJ_q6ChRmQihya9xKhRsI0fNAk" alt="icon" />
                Laravel – PHP framework for web applications
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://www.svgrepo.com/show/354119/nodejs-icon.svg" alt="icon" />
                Node.js – JavaScript runtime for backend development
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://cdn-icons-png.flaticon.com/512/919/919830.png" alt="icon" />
                PHP – Server-side scripting language
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://images.ctfassets.net/zojzzdop0fzx/4jWojoqYZoayRvNy8av2jr/e86d85fec34cc1cb4b7a96787b343759/react-icon.svg?fm=webp&w=3840&q=75" alt="icon" />
                React – JavaScript library for building UIs
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://pbs.twimg.com/profile_images/1735429515541938176/zOO1N7Su_400x400.jpg" alt="icon" />
                Render – Cloud platform for deploying web apps
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://www.svgrepo.com/show/374118/tailwind.svg" alt="icon" />
                TailwindCSS – Utility-first CSS framework
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://www.svgrepo.com/show/354513/vercel-icon.svg" alt="icon" />
                Vercel – Frontend hosting platform for frameworks
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://img.icons8.com/?size=160&id=eETV3RNHVrWA&format=png" alt="icon" />
        ...
        <li>
            ...
            <ul className="pl-4 space-y-6">
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://cdn-icons-png.flaticon.com/512/5968/5968517.png" alt="icon" />
                Google Workspaces – Cloud-based office tools (Docs, Sheets, etc.)
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjK11NF_w_pmnje3cgjfLjtHvCEvmyQwXndadLabUnHiOhziXHhAEq8ZVImQXTF9NUi0g" alt="icon" />
                LibreOffice – Free and open-source office suite
            </li>
            <li className="flex items-center gap-3">
                <img className="w-6 h-6 object-contain rounded-sm" src="https://images.icon-icons.com/1156/PNG/512/1486565573-microsoft-office_81557.png" alt="icon" />
