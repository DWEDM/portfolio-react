          ...
          <div className="max-w-full m-4">
            ...
            <div className="card  max-w-full shadow-sm">
              <figure className="px-5 flex flex-col gap-2">
                <img src={img1} alt="Screenshot 1" className="rounded-xl shadow-xl w-full max-h-[300px] object-cover" />
                <img src={img2} alt="Screenshot 2" className="rounded-xl shadow-xl w-full max-h-[300px] object-cover" />
              </figure>
