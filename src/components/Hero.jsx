...
const Hero = () => {
  return (
    <>
      <div className="hero h-auto border-2 border-accent rounded-2xl">
        <div className="hero-content text-left">
          <div className="max-w-full m-4">
            ...
            I consider myself methodical and adaptable, especially when working with technical problems 
